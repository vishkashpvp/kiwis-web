...
export default function Terms() {
  return (
    <main className="p-6 max-w-3xl mx-auto">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Account & Authentication</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Gmail Access</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">MVP Limitations</h2>
      <p className="mb-4">
